...
[![GitHub release](https://img.shields.io/github/release/<%= repoName %>.svg?style=flat-square)](https://github.com/<%= repoName %>)
[![Build Status](https://travis-ci.org/<%= repoName %>.svg?style=flat-square&branch=master)](https://travis-ci.org/<%= repoName %>)
[![GitHub issues](https://img.shields.io/github/issues/<%= repoName %>.svg?style=flat-square)](https://github.com/<%= repoName %>/issues)
[![XO code style](https://img.shields.io/badge/code_style-XO-5ed9c7.svg?style=flat-square)](https://github.com/sindresorhus/xo)
[![Polymer Skeleton](https://img.shields.io/badge/polymerX-SKELETON-435877.svg?style=flat-square)](https://github.com/<%= repoName %>)
...
```bash
git clone https://github.com/<%= repoName %> [your-app-name]
```
